...
<head>
    ...
    <title>Admin Panel - Pengaturan</title>
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-1 fw-bold">Nama Website</h6>
                        <p class="card-text" id="nama_website"></p>
                        <h6 class="card-subtitle mb-1 fw-bold">Tentang Kami</h6>
                        <p class="card-text" id="tentang_kami"></p>
                    </div>
                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_website" id="nama_website_inp" class="form-control shadow-none" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Tentang Kami</label>
                                        <textarea name="tentang_kami" id="tentang_kami_inp" class="form-control shadow-none" rows="6" required></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Nomor Telepon</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="alamat" id="alamat_inp" class="form-control shadow-none" required>
                                                </div>
                                                <div class="mb-3">
                ...
                <!-- Management Team Section V9-->
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-tittle m-0">Management Team</h5>
